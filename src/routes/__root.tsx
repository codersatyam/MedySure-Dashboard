  ...
  head: () => ({
    meta: [
      ...
      { title: "MediFlow AI — Healthcare Operations Platform" },
      {
        name: "description",
        content:
          "The intelligent operating system for modern healthcare organizations — patients, appointments, billing, and analytics in one platform.",
      },
      { name: "author", content: "MediFlow AI" },
